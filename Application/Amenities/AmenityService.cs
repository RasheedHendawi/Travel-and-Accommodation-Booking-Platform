...
namespace Application.Amenities
{
    public class AmenityService : IAmenityService
    {
        ...
        public async Task<IEnumerable<AmenityResponse>> GetAmenitiesAsync(AmenitiesGetRequest request)
        {
            ...
            return amenities.Items.Select(a => _mapper.Map<AmenityResponse>(a)).ToList();
        }
