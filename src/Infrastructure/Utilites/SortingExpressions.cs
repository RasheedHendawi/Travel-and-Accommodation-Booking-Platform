    ...
    public static class SortingExpressions
    {
          ...
          string? sortColumn)
        {
            return sortColumn?.ToLower() switch
            {
                "id" => rc => rc.Id,
                "name" => rc => rc.Name,
                "adultscapacity" => rc => rc.AdultCapacity,
                "childrencapacity" => rc => rc.ChildCapacity,
                "pricepernight" => rc => rc.Price,
                _ => rc => rc.Id
            };
        }
        ...
        public static Expression<Func<Booking, object>> GetBookingSortExpression(string? sortColumn)
        {
            return sortColumn?.ToLower() switch
            {
                ...
                "checkindate" => b => b.CheckIn,
                "checkoutdate" => b => b.CheckOut,
                _ => b => b.Id
            };
        }
    }
